---
title: Latihan Penalaran Induktif
description: Latihan menarik kesimpulan umum dari data, grafik, dan fenomena spesifik.
---

# 📈 Latihan Penalaran Induktif

> [!TIP] Apa itu Penalaran Induktif?
> Berbeda dengan deduktif yang "pasti", penalaran induktif berkaitan dengan **peluang (probabilitas)**.
> Tugas Anda adalah mencari kesimpulan yang **PALING MUNGKIN BENAR** berdasarkan data atau fakta yang disajikan, bukan mencari kebenaran mutlak matematika.

---

## Bagian 1: Analisis Sebab-Akibat (Kausalitas)

**Bacalah teks berikut dengan saksama!**

::: info 🌋 Stimulus: Fenomena Gunung Berapi
...
## Bagian 2: Interpretasi Data & Tren

**Perhatikan data pada tabel berikut!**

::: info 📊 Tabel: Jumlah Penduduk (dalam juta)
...
**Pembahasan:**
* Penduduk tahun 2000 = $11,3$ juta.
* Penduduk tahun 2005 = $12,1$ juta.
* Selisih kenaikan = $12,1 - 11,3 = 0,8$ juta.
* Persentase kenaikan:
    $$\frac{0,8}{11,3} \times 100\% \approx 7,079\%$$
...
**Analisis Data:**
1.  **1990 - 1995:** $40,8 - 36,5 = \mathbf{4,3}$ juta.
2.  **1995 - 2000:** $42,5 - 40,8 = 1,7$ juta.
3.  **2000 - 2005:** $46,0 - 42,5 = 3,5$ juta.

**Kesimpulan:**
Kenaikan terbesar (signifikan) terjadi pada periode pertama, yaitu **1990 hingga 1995** dengan penambahan 4,3 juta jiwa.
:::

---

## Bagian 3: Generalisasi & Anomali (Paradoks)

**Bacalah teks berikut!**

::: warning 📉 Kasus: Anggaran vs Kemiskinan
